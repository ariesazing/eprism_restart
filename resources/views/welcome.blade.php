        ...
        <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-8">
            ...
            <nav class="flex items-center gap-3 text-sm">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="rounded-xl bg-cherry-700 px-4 py-2 font-medium text-white hover:bg-cherry-800">Register</a>
                @endauth
            </nav>
        </div>
    </header>
        ...
        <section class="relative isolate overflow-hidden">
            ...
            <div class="mx-auto max-w-5xl px-6 py-20 text-center lg:px-8">
                ...
                <div class="mt-10 flex flex-wrap items-center justify-center gap-4">
                    <a href="{{ auth()->check() ? route('dashboard') : route('register') }}" class="rounded-xl bg-cherry-700 px-7 py-3 text-sm font-semibold text-white shadow-sm hover:bg-cherry-800">
