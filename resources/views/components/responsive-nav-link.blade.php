...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-cherry-400 text-start text-base font-medium text-cherry-700 bg-cherry-50 focus:outline-none focus:text-cherry-800 focus:bg-cherry-100 focus:border-cherry-700 transition duration-150 ease-in-out'
