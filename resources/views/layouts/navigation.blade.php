...
>
    ...
    <nav class="flex-1 space-y-1 overflow-y-auto overflow-x-hidden px-3 py-2">
        <x-responsive-nav-link class="rounded-lg whitespace-nowrap" :href="route('dashboard')" :active="request()->routeIs('dashboard')" title="Dashboard">
        ...
        <x-responsive-nav-link class="rounded-lg whitespace-nowrap" :href="route('repository.index')" :active="request()->routeIs('repository.index')" title="Repository">
        ...
        @auth
            @if (Auth::user()->isResearcher())
                <x-responsive-nav-link class="rounded-lg whitespace-nowrap" :href="route('submissions.index')" :active="request()->routeIs('submissions.*')" title="My Submissions">
            ...
            @if (Auth::user()->isReviewer() && Auth::user()->isApproved())
                <x-responsive-nav-link class="rounded-lg whitespace-nowrap" :href="route('reviewer.submissions.index')" :active="request()->routeIs('reviewer.submissions.*')" title="Reviewer Queue">
            ...
            @if (Auth::user()->isAdmin() && Auth::user()->isApproved())
                <x-responsive-nav-link class="rounded-lg whitespace-nowrap" :href="route('admin.users.index')" :active="request()->routeIs('admin.users.*')" title="Users">
                ...
                <x-responsive-nav-link class="rounded-lg whitespace-nowrap" :href="route('admin.submissions.index')" :active="request()->routeIs('admin.submissions.*') || request()->routeIs('admin.reviews.*')" title="Reviewer Assignment">
                ...
                <x-responsive-nav-link class="rounded-lg whitespace-nowrap" :href="route('admin.reports')" :active="request()->routeIs('admin.reports')" title="Reports">
                ...
                <x-responsive-nav-link class="rounded-lg whitespace-nowrap" :href="route('admin.activity.index')" :active="request()->routeIs('admin.activity.*')" title="Activity Log">
    ...
    <div class="border-t border-slate-200 p-4">
        @auth
            ...
            <div class="mt-3 space-y-1" :class="collapsed ? 'lg:mt-0' : ''">
                <x-responsive-nav-link class="rounded-lg whitespace-nowrap" :href="route('profile.edit')" :active="request()->routeIs('profile.edit')" title="Profile">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-responsive-nav-link class="rounded-lg whitespace-nowrap" href="{{ route('logout') }}"
                            title="Log Out"
