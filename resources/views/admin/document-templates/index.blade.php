                ...
                <div class="mt-3 grid gap-4">
                    @foreach ($templates as $template)
                        <div class="app-card flex flex-col gap-3 bg-white p-5 md:flex-row md:items-center md:justify-between">
                            ...
                            <a href="{{ route('admin.document-templates.edit', $template['key']) }}" class="rounded-xl bg-cherry-700 px-4 py-2 text-center text-sm font-medium text-white hover:bg-cherry-800"><x-action-icon action="Edit Template" />Edit Template</a>
                        </div>
                    @endforeach
                </div>
            </section>
